...
Large static values for Cu2 atom (Table~\ref{tab:enst_temp}) indicate the potential instability of this position. 
\textcolor{red}{According to structurel study of tennantie Cu2\cite{Hathwar2019} position may be describied as 6 differnt Cu position.
But according our study even after dividing Cu2 position into Cu2 and Cu 21, the Cu2 position remains highly disordered and there are no reasons for adding additional positions.}
This disordering is reliably described by the anharmonic model of atomic displacements using the Gram-Charlier expansion to the 4th order.
