...
\begin{abstract}
Synthetic tennantite, Cu\textsubscript{12}As\textsubscript{4}S\textsubscript{13}, is the analogue of an abundant mineral that belongs to the tennantite-tetrahedri\textcolor{red}{t}e group with a low lattice thermal conductivity.
\textcolor{red}{Combined data from high-quality X-ray diffraction, electron microscopy (STEM--HAADF), Raman spectroscopy, as well as DFT calculations are used to analyze the peculiarities of its structure stability and dynamics.
...
\begin{itemize}
  ...
  \item Jahn-Teller distortions give rise to a set of unit cells with close \textcolor{red}{ground} state energies
...
\textcolor{red}{For instance, tetrahedrite doped with Mn, Fe, Co, Ni, Zn, Te, Se showed ZT values in the range from 0.2 to 1.13\cite{Heo2014,Suekuni2013,Lu2012,Barbier2016,Rout2020,Zhu2019}.}

\textcolor{red}{The tennantite structure is treated as a sphalerite-type, thus conforms to the \hmn{I -4 3 m} space group\cite{yaroslavzev2019,Makovicky_2006}.
...
This effect is accompanied by As1 and S2 atoms displacement, which was also observed in \textcolor{red}{Ref.}~\cite{Hathwar2019}.
...
However, the relationships between the peculiarities of the tennantite crystal and its electronic structures and thermoelectric properties, including the behavior of Laves \textcolor{red}{polyhedra} in the structure, were put aside in the previous paper\cite{yaroslavzev2019}.
...
The spherical single-crystal structural study results are presented in Supplementary Material, and they are compared with the structural data \textcolor{red}{from} the \textcolor{red}{regularly shaped crystal} sample\cite{yaroslavzev2019}.
...
\textcolor{red}{The structure was refined in a way similar to previously described in Ref.~\cite{yaroslavzev2019}.
...
Large static values for Cu2 atom (Table~\ref{tab:enst_temp}) \textcolor{red}{confirmed instability of this site\cite{Hathwar2019,yaroslavzev2019}}.
...
Within \textcolor{red}{the approach above}, the Einstein solid model is used to describe independent harmonic oscillators.
...
\textcolor{red}{Same modes were observed and analyzed in tetrahedrites\cite{May2016,Lai2015} with energies approximately 4, 9 and 18 meV (33, 72, 145 cm\textsuperscript{-1}) which is
...
The unit cell contains Laves \textcolor{red}{polyhedra} formed by copper atoms around sulphur ones (Figure~\ref{fig:init_and_opt_laves}, number 0).
...
\centering
 ...
 \caption{\label{fig:init_and_opt_laves} The geometries of SCu\textsubscript{6} Laves \textcolor{red}{polyhedra} before and after structural optimization. sulphur atoms are shown in yellow, copper atoms before optimization are shown in grey, and after optimization in blue. VESTA\cite{Momma2011} was used for the visualisation. }
\end{figure}
...
\textcolor{red}{The tennantite structure tends to conform to the asymmetric covalent polar bonds and its charge distribution is significantly affected by the atomic shifts in Laves polyhedra.
