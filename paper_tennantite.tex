...
Due to the crystal growth method used, we suspected a possibility of anisotropic extinction.
The intensity vs  $\psi$ angle were measured for several reflections to analyze this effect.

The results are presented in Fig.~\ref{fig:rock_curv} .
All curves were approximated by the least-square fitting.
Only for \hkl[4 0 0], \hkl[0 4 0], and \hkl[0 0 4] reflections the coefficients with $x$ and $x^{2}$ were in the range of 5--8$\sigma$, while for the two other sets they were about $\sigma$ or less (with one 2$\sigma$ exception).
Thus, we conclude that the intensities of weak reflections at small angles and reflections at high angles have fixed $\psi$ angles.
On the contrary, $\psi$ angles of strong reflections with small $\sin\theta/\lambda$ vary, that may indicate an anisotropic extinction.

\begin{figure*}
\centering
\subfigure{\includegraphics[width=0.3\textwidth]{200}}
 \quad
\subfigure{\includegraphics[width=0.3\textwidth]{400}}
 \quad
\subfigure{\includegraphics[width=0.3\textwidth]{1200}}
\caption{\label{fig:rock_curv} Normalized intensities of reflections vs. $\psi$ angle; left --- 200, 020, 002 (weak, sin=0.098), middle --- 400, 040, 004 (strong, sin=0.197), right --- 1200, 0120, 0012 (moderate, sin=0.590).}
\end{figure*}
...
The extinction can be explained by the dynamic disorder of Cu21 atoms. Such a disorder is observed in the analyzed HAADF image of the sample in [110] zone (Fig.~\ref{fig:micro}).
